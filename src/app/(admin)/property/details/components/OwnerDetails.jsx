      ...
      <Card>
        ...
        <CardBody>
          <div className="text-center">
            <img src={avatar1} alt="avatar" className="avatar-xl rounded-circle border border-2 border-light mx-auto" />
            <div className="mt-2">
      ...
      <Card>
        ...
        <form onSubmit={handleSubmit(() => {})}>
          <CardBody>
            ...
            <div>
              <TextAreaFormInput control={control} name="description" type="text" className="form-control" id="schedule-textarea" rows={5} placeholder="Message" />
            </div>
          </CardBody>
          <CardFooter className="bg-light-subtle">
