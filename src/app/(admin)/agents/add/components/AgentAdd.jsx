      ...
      <Card>
        ...
        <CardBody>
          <Row>
            ...
            <Col lg={6}>
              <div className="mb-3">
                <TextFormInput control={control} name="propertiesNumber" type="number" placeholder="Enter Properties Number" label="Properties Number" />
              </div>
            </Col>
            <Col lg={12}>
              <div className="mb-3">
                <TextAreaFormInput control={control} name="description" type="text" label="Agent Address" className="agent-address" id="schedule-textarea" rows={3} placeholder="Enter address" />
              </div>
            </Col>
            <Col lg={4}>
              <div className="mb-3">
