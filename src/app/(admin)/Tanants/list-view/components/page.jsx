...
const ListViewPage = () => {
  return <>
      <PageTitle surname="Real Estate"  title="Tenants List" />
      <Row>
        <Col lg={12}>
          <Card>
                  ...
                  <Row className="align-items-center">
                    <Col lg={6}>
                      <form className="app-search d-none d-md-block me-auto">
                        <div className="position-relative">
                          <input type="search" className="form-control" placeholder="Search Tenants" autoComplete="off" />
                    ...
                    <Col lg={4}>
                      <h5 className="text-dark fw-medium mb-0">
                        311 <span className="text-muted"> tenants</span>
                      </h5>
                    </Col>
                  </Row>
                </Col>
